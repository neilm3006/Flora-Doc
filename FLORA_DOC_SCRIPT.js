...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Handle moisture form submission
    const moistureForm = document.getElementById('submit-moisture-btn');
    if (moistureForm) {
        moistureForm.addEventListener('click', () => {
            const minMoisture = document.getElementById('min-moisture').value;
            const maxMoisture = document.getElementById('max-moisture').value;
            
            if (!minMoisture || !maxMoisture) {
                showModal({
                    title: 'Missing Information',
                    message: 'Please enter both minimum and maximum moisture levels.',
                    type: 'warning',
                    cancelButton: false
                });
                return;
            ...
            if (Number(minMoisture) >= Number(maxMoisture)) {
                showModal({
            ...
            showModal({
                title: 'Moisture Levels Set',
                message: `Min: ${minMoisture}, Max: ${maxMoisture}`,
                type: 'success',
                cancelButton: false
            });
